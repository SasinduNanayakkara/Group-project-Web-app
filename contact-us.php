...
if (isset($_POST['submit'])) {
    ...
    if (empty($errors)) {
        ...
        $message = mysqli_real_escape_string($connection, $_POST['subject']);

        $query = "INSERT INTO contact_us
                        (first_name, last_name, email, subjects)
    ...
    <div class="main">
        ...
        <section id="contact-form">
            <div class="contact-form">
                <center>
                    <h1 class="contact-heading"><strong>Contact Us</strong></h1>
                </center>
                ...
                <div class="fl001">
                    ...
                    <div class="fl002">
                        <form action="contact-us.php" method="POST">
                            <label class="lab001" for="fname">First Name :</label><br>
                            <input class="contact-input" type="text" id="fname" name="firstname" placeholder="first name..">
                            <br><br>

                            <label class="lab001" for="lname">Last Name :</label><br>
                            <input class="contact-input" type="text" id="lname" name="lastname" placeholder="last name..">
                            <br><br>

                            <label class="lab001" for="email">Email :</label><br>
                            <input class="contact-input" type="email" name="email" id="contact-email" placeholder="email...">
                            <br><br>

                            <label class="lab001" for="Message">Message :</label><br>
                            <textarea class="contact-input" id="Message" name="subject" placeholder="Write something.." style="height:200px"></textarea>
                            <br><br>
                    ...
                    <div class="fl002">
                        ...
                        <h2 class="mpd001"><b>Musify Phone Number</b></h2>
                        <p class="mpd002"> (011) 2896 775</p>
                        ...
                        <h2 class="mpd001"><b> Musify Email</h2></b> </h2>
                        <p class="mpd002"> musify@music.lk</p>
                        ...
                        <h2 class="mpd001"><b> Musify Address </b></h2>
                        <p class="mpd002"> 12, ward place, colombo 7</p>
