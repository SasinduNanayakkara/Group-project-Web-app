    ...
    <section id="all-products">
        <div class="all-products-div">
            <div class="product-grid-div">
                <div border-width: 1px;" class="item-two">
                ...
                <div class="item-two">
                    <div class="card-item">
                        <img src="images/drums/drums-19.jpg" class="g-card-1" alt="Denim Jeans" style="width:100%;">
                        <h1 style="margin: 0px;">XSR1607B (16 FASH) </h1>
                        <p class="price">Rs.3,400.00</p>
                        <p style="margin-bottom: 0px;"><button type="button" class="buy-b"><i class="fas fa-shopping-bag"></i> Buy Now</button></p>
                    </div>
                </div>
                <div class="item-two">
                    <div class="card-item">
                        <img src="images/drums/drums-20.jpg" class="g-card-1" alt="Denim Jeans" style="width:100%;">
                        <h1 style="margin: 0px;">SDW</h1>
