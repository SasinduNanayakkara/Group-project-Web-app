...
if (isset($_GET['keyboard19'])) {

    $query19 = "SELECT keyboard_name,item_code,price,keyboard_location
                                FROM keyboards WHERE keyboard_id = 19";
...
if (isset($_GET['keyboard20'])) {

    $query20 = "SELECT keyboard_name,item_code,price,keyboard_location
                                FROM keyboards WHERE keyboard_id = 20";
...
<body>
    ...
    <section id="navigation-bar">
        ...
        <section id="all-products">
            <form action="keyboards3.php" method="get">
                <div class="all-products-div">
                    <div class="product-grid-div">
                        ...
                        <div class="item-two">
                            <div class="card-item">
                                <img src="images/keyboards/keyboard-19.jpg" class="g-card-1" alt="Denim Jeans" style="width:100%;">
                                <h1 style="margin: 0px;">Clavia Nord 49-Key</h1>
                                <p class="price">Rs.200,000.00</p>
                                <p style="margin-bottom: 0px;"><button type="submit" name="keyboard19" class="buy-b"><i class="fas fa-shopping-bag"></i> Buy Now</button></p>
                            </div>
                        </div>
                        <div class="item-two">
                            <div class="card-item">
                                <img src="images/keyboards/keyboard-20.jpg" class="g-card-1" alt="Denim Jeans" style="width:100%;">
                                <h1 style="margin: 0px;">KROSS 2-61</h1>
                                <p class="price">Rs.170,000.00</p>
                                <p style="margin-bottom: 0px;"><button type="submit" name="keyboard20" class="buy-b"><i class="fas fa-shopping-bag"></i> Buy Now</button></p>
                            </div>
                        </div>
                        <div></div>
                        <div></div>
    ...
    <section>
        <div class="row1">
            <form action="" class="social-items">
                <a href="http://facebook.com"><img src="images/icons/5293-facebook_102565.ico" alt="facebook" class="icon" srcset=""></a>
